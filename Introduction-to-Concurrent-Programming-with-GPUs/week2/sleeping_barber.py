...
# You can modify the code to see what the effect will be and to make it run. 
# The program must run to completion and output the total amount of Euros that the barbers have earned.
import time
import random
import threading
...
class Barber(threading.Thread):     # Consumer Thread
    ...
    def run(self):
        ...
        while SHOP_OPEN:
            ...
            customer.task_done()    # Indicate that a formerly enqueued task is complete
